var xkcdService = app.service('XKCDService', ['$q', 'PhoneService', function($q, PhoneService) {
	// note: localStorage can only store strings, that is why we stringify when putting data, and parsing when we retrieve
	...
	return {
		get: function(comicNumber) {
			var phoneCall;
			var attemptingNewer = false; // default this to false
